        ...
        <div class="panel-content">
            <div class="input-group">
                ...
                <div class="flex gap-3">
                    <label>
                        Localidad
                        <input type="text" id="localidad" name="localidad" value="{{session('shop.usuario.datos.localidad')}}">
                    </label>

                    <label>
                        Código postal
                        <input type="text" id="codigo_postal" name="codigo_postal" pattern="[0-9]+" title="Sólo se permiten números" value="{{session('shop.usuario.datos.codigo_postal')}}">
                    </label>
                </div>
